...
public class mainController {
	...
	public String updateCustomerInfo(CustDto customerDto, RedirectAttributes redirectAttributes) {
	...
	public String updatePicInfo(CustDto customerDto, RedirectAttributes redirectAttributes) {
